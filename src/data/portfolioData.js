...
export const projects = [
  {
    ...
    github: 'https://github.com/nihalkumar',
    demo: '#',
    featured: true,
...
export const contact = {
  ...
  socials: [
    { label: 'GitHub',   href: 'https://github.com/nihalkumar',   icon: 'github' },
    { label: 'LinkedIn', href: 'https://linkedin.com/in/nihalkumar', icon: 'linkedin' },
    { label: 'Twitter',  href: 'https://twitter.com/nihalkumar',   icon: 'twitter' },
    { label: 'Instagram',href: 'https://instagram.com/nihalkumar', icon: 'instagram' },
  ],
};
